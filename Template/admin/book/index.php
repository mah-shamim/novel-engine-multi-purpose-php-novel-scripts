...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?=AdminURL?>">Home</a> /</span> <a href="<?=AdminURL?>/category">Book</a> </h4>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 showingBy">All Book</h5>
            
            <div class="d-flex justify-content-end">
            <div class="btn-group" role="group" aria-label="Basic example">
                              <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addsmodal"><span class="tf-icons mdi mdi-plus me-1"></span> Add Book</button>
                              <div class="btn-group">
    ...
    <table id="dataTable" class="table table-striped table-bordered nowrap reports " width="100%" cellspacing="0" data-table="book" data-filter="ALL">
    <thead>
            <tr>
                <th>Id</th>
                <th>Image</th>
...
<div class="custom-switch custom-switch-label-status pl-0 ml-3">
 ...
 <div class="modal fade" id="editmodal" tabindex="-1" style="display: none;" aria-hidden="true">
                          ...
                          <form id="addpost" method="post" enctype="multipart/form-data">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="modalCenterTitle">Edit Book</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
 ...
 <label for="Image">Image URL</label>
        ...
        <div class="row mt-3 mb-3">
          ...
          <div class="col-md-6 mb-2">
                                ...
                                <div class="col-md-12 mb-2">
                                  <div class="form-floating form-floating-outline">
                                    <textarea class="form-control custom-height" id="desc2" name="desc"> <div class="dectext"></div> </textarea>
                                    <label for="title">Description</label>
                                  </div>
                                  </div>
        <div class="col-md mb-2">
 ...
 <div class="modal fade" id="addmodal" tabindex="-1" style="display: none;" aria-hidden="true">
                        ...
                        <form id="addpost" method="post" enctype="multipart/form-data">
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h4 class="modal-title" id="exampleModalLabel3">Add Book</h4>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
    ...
    <div class="col-md-9 mb-2">
        ...
        <div id="url_show" style="display: none;" class="form-floating form-floating-outline">
            ...
            <label for="Image">Image URL</label>
                                ...
                                <div class="col-md-12 mb-2">
                                  <div class="form-floating form-floating-outline">
                                    <textarea class="form-control desc4" id="" name="desc"></textarea>
                                    <label for="title">Description</label>
                                  </div>
                                  </div>
                                <div class="col-md-12 mb-2">
                        ...
                        <div class="col-sm-4 col-md-2 col-6">
                        <label class="form-check-label m-3" for="Free">Free </label>
                        <div class="custom-switch custom-switch-label-status pl-0 ml-3">
                            <input class="custom-switch-input" name="Free" id="Free" type="checkbox">
                            <label class="custom-switch-btn" for="Free"></label>
                        </div>
                        </div>
