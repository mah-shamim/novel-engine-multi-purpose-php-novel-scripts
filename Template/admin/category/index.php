...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?=AdminURL?>">Home</a> /</span> <a href="<?=AdminURL?>/category">Category</a> </h4>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 showingBy">All Category</h5>
            
            <div class="d-flex justify-content-end">
            <div class="btn-group" role="group" aria-label="Basic example">
                              <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addmodal"><span class="tf-icons mdi mdi-plus me-1"></span> Add Category</button>
                              <div class="btn-group">
...
<div class="modal fade" id="addsmodal" tabindex="-1" style="display: none;" aria-hidden="true">
 ...
 <label for="Image">Image URL</label>
        ...
        <div class="col-md-12 mb-2">
          <div class="form-floating form-floating-outline">
            <textarea class="form-control desc3" id="" name="desc"></textarea></div>
        ...
        <div class="row mt-3 mb-3">
          ...
          <div class="form-floating form-floating-outline">
            <div id="img_preview"></div>
                                ...
                                <div class="col-md-12 mb-2">
                                  <div class="form-floating form-floating-outline">
                                    <textarea class="form-control desc" id="desc2" name="desc"> <div class="dectext"></div> </textarea>
                                    <label for="title">Description</label>
                                  </div>
                                  </div>
        <div class="col-md mb-2">
