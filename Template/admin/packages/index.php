...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?=AdminURL?>">Home</a> /</span> <a href="<?=AdminURL?>/packages">Packages</a> </h4>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 showingBy">All Packages</h5>
            
            <div class="d-flex justify-content-end">
            <div class="btn-group" role="group" aria-label="Basic example">
                              <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addmodal"><span class="tf-icons mdi mdi-plus me-1"></span> Add Packages</button>
                              <div class="btn-group">
    ...
    <table id="dataTable" class="table table-striped table-bordered nowrap reports " width="100%" cellspacing="0" data-table="packages" data-filter="ALL">
    <thead>
            <tr>
                <th>Id</th>
                <th>Package Name</th>
                          ...
                          <form id="addpost" method="post" enctype="multipart/form-data">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="modalCenterTitle">Edit Author</h4>
 ...
 <div class="modal fade" id="addmodal" tabindex="-1" style="display: none;" aria-hidden="true">
                        ...
                        <form id="addpost" method="post" enctype="multipart/form-data">
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h4 class="modal-title" id="exampleModalLabel3">Add Packages</h4>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md mb-2">
                                  ...
                                  <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="title">Package Price (N)</label>
                                  </div>
                                </div>
                              </div>
