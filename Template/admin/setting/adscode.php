...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?=AdminURL?>">Home</a> /</span> <span class="text-muted fw-light"><a href="<?=AdminURL?>/setting">Setting</a> /</span> <a href="<?=AdminURL?>/adscode">Ads Code</a> </h4>
