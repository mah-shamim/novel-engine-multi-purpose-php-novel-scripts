...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?=AdminURL?>">Home</a> /</span> <a href="<?=AdminURL?>/payments">Payments</a> </h4>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 showingBy">All Payments</h5>
    ...
    <table id="dataTable" class="table table-striped table-bordered nowrap reports " width="100%" cellspacing="0" data-table="payments" data-filter="ALL">
    <thead>
            <tr>
                <th>Id</th>
                <th>Username</th>
