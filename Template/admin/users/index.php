...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 showingBy">All Users</h5>
    ...
    <table id="dataTable" class="table table-striped table-bordered nowrap reports " width="100%" cellspacing="0" data-table="users" data-filter="ALL">
    <thead>
            <tr>
                <th>Id</th>
                <th>Image</th>
