...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?=AdminURL?>">Home</a> /</span> <a href="<?=AdminURL?>/author">Author</a> </h4>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 showingBy">All Author</h5>
            
            <div class="d-flex justify-content-end">
            <div class="btn-group" role="group" aria-label="Basic example">
                              <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addmodal"><span class="tf-icons mdi mdi-plus me-1"></span> Add Author</button>
                              <div class="btn-group">
    ...
    <table id="dataTable" class="table table-striped table-bordered nowrap reports " width="100%" cellspacing="0" data-table="author" data-filter="ALL">
    <thead>
            <tr>
                <th>Id</th>
                <th>Image</th>
 ...
 <div class="modal fade" id="addmodal" tabindex="-1" style="display: none;" aria-hidden="true">
                        ...
                        <form id="addpost" method="post" enctype="multipart/form-data">
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h4 class="modal-title" id="exampleModalLabel3">Add Author</h4>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
