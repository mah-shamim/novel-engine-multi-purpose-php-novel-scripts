    ...
    <section class="blog-section p-40">
      <div class="container">
        <div class="top-row blog-bar mb-40">
          <div class="heading mb-0">
            <h3>Our Latest Blogs</h3>
          </div>
          <h6>
            <a href="/blogs" class="cus-btn"><span class="icon"><img src="<?php echo MAIN_ASSETS;?>/media/icons/click-button.png"
                  alt="" /></span>SEE MORE</a>
          </h6>
        </div>
        <div class="row mb-40">
