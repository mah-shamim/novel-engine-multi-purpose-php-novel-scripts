                            ...
                            <div class="form-block bg-lightest-gray">
                                ...
                                <form class="auth" method="POST">
                                    ...
                                    <button type="submit" class="b-unstyle cus-btn w-100 mb-24">
                                        <span class="icon"><img src="<?=MAIN_ASSETS?>/media/icons/click-button.png" alt=""></span>Login
                                    </button>
                                </form>
                                <div class="register-bottom">
                                    <h6>If you don’t have account? <a href="/signup" class="color-primary">Register</a></h6>
                                    <h6 class="text-end"><a href="/forgot-password" class="color-primary">Forgot Password?</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 ">
