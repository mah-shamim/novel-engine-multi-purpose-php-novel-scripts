                            ...
                            <div class="form-block bg-lightest-gray">
                                ...
                                <form method="POST" class="auth">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-24">
                                                <input type="text" class="form-control" id="first-name" name="name" required placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-24">
                                                <input type="text" class="form-control" id="last-name" name="username" required placeholder="Username">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-24">
                                    ...
                                    <button type="submit" class="b-unstyle cus-btn w-100 mb-24">
                                        <span class="icon"><img src="<?=MAIN_ASSETS?>/media/icons/click-button.png" alt=""></span>Create Account
                                    </button>
                                        
                                </form>
                                <div class="text-end">
                                    <h6>Already have an account? <a href="/login" class="color-primary">Log in</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
