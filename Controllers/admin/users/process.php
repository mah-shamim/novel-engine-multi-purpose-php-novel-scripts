...
$orderDirection = $_POST['order'][0]['dir'];
    ...
    $dropDown .= '<a href="'.AdminURL.'/subscribe?id='.$id.'" class="dropdown-item d-flex align-items-center waves-effect text-info">Subscribe</a></li>
    <li>';
                        ...
                        foreach($ids as $id) {
                            ...
                            try {
                                ...
                                $deleteRow = $Gen->getRow($table, 'id', $id);
                                 $file = PUBLICPATH.'/thumb/users/'.$deleteRow['image'];
