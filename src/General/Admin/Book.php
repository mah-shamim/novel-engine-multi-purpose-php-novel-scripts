    ...
    class Book extends Database {
        ...
        public function Set()
        {
            ...
            if(!$All->detectTable($this->table)) {
                ...
                $All->createTable($this->table, $columns, $PKey, $Fkey, 'category');
            }
        }
        ...
        public function Add($data) {
            ...
            if (empty($errorMessage) && (!empty($data['img_name']) || !empty($data['img_url']))) {
                ...
                if (checkImageSize($data)) {
                    ...
                    $imageName = uploadThumb($data, $this->table);
                    if ( $imageName === false) {
            ...
            $m = "name field cannot be empty";
                ...
                if(empty($data['img_name']) && empty($data['img_url'])) {
                    ...
                    if(checkImageSize($data)) {
                        ...
                        $upload = uploadThumb($data, $this->table);
                        if($upload === false) {
                            $m = "Image upload fail";
                        } else {
                            $imageName = $upload;
